...
import { dislikePoint, likePoint } from "../../../../apihelpers/helpers";


const DiaryItem = ({location, id, point, likes, dislike}) => {
  ...
  const dislikeMe = () => {
    const userid = localStorage.getItem("userId");
    dislikePoint(id, userid).then((data) => {
      console.log(data);
      if(data.type === "added"){
