...
import { likeImage, dislikeImage, likeHotel, dislikeHotel } from "../../../../apihelpers/helpers";

const DiaryItem = ({location, id, hotels, likes, dislike}) => {
  ...
  const dislikeMe = () => {
    const userid = localStorage.getItem("userId");
    dislikeHotel(id, userid).then((data) => {
      console.log(data);
      if(data.type === "added"){
