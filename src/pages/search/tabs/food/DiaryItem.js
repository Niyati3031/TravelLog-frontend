...
import {dislikeFood, likeFood } from "../../../../apihelpers/helpers";

const DiaryItem = ({location, id, food, likes, dislike}) => {
  ...
  const dislikeMe = () => {
    const userid = localStorage.getItem("userId");
    dislikeFood(id, userid).then((data) => {
      console.log(data);
      if(data.type === "added"){
