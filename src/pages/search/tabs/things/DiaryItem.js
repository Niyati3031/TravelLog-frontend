...
import {likeThing, dislikeThing } from "../../../../apihelpers/helpers";


const DiaryItem = ({location, id, things, likes, dislike}) => {
  ...
  const dislikeMe = () => {
    const userid = localStorage.getItem("userId");
    dislikeThing(id, userid).then((data) => {
      console.log(data);
      if(data.type === "added"){
